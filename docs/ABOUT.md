...
- **Licensing and pricing information** - Displays free personal license terms under PolyForm Noncommercial 1.0.0 and commercial license pricing (USD 49 per installation, perpetual with 12 months updates) via Connections checkout - `index.html:1594`
